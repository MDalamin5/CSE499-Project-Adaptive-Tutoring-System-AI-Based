...
prompt_correct = ChatPromptTemplate.from_messages(
    [
        ("system", 
         ...
         Generate adaptive_prompt and it should be in json format.
         {format_instructions}
...
def setup_llm(adaptive_prompt=""): # Added adaptive_prompt as argument with default value
    model = ChatGroq(model_name="gemma2-9b-it", temperature=0.1) # Lower temperature for more predictable responses

...
1.  শিক্ষার্থীর বার্তা বুঝুন:
    ...
    *   যদি শিক্ষার্থী কোনো নতুন গাণিতিক বিষয় শিখতে চায়: বিষয়টির একটি সংক্ষিপ্ত পরিচিতি দিন এবং মূল ধারণাগুলো ব্যাখ্যা করুন। শিক্ষার্থী যদি বলে "আমি এখন {{topic}} শিখতে চাই" অথবা "চলুন {{topic}} সম্পর্কে জানি" অথবা "নতুন কিছু শিখতে চাই", তাহলে বুঝবেন তারা একটি নতুন বিষয় শুরু করতে চাইছে।
...
2.  সমস্যা সমাধানের ধাপসমূহ:
    ...
    iii.  **বোঝার জন্য জিজ্ঞাসা:** প্রতিটি ধাপের পরে, শিক্ষার্থী এই ধাপটি বুঝতে পেরেছে কিনা জিজ্ঞাসা করুন। আপনি এই ধরনের প্রশ্ন করতে পারেন:
...
এখন, শিক্ষার্থীর বার্তাটি মনোযোগ দিয়ে পড়ুন এবং সেই অনুযায়ী কাজ করুন। যদি শিক্ষার্থী কোনো বিষয় নির্বাচন করে, তাহলে সেই বিষয়ের উপর একটি সংক্ষিপ্ত ভূমিকা দিয়ে শুরু করুন।
"""
...
def setup_runnable(_model):
    ...
    runnable = RunnableWithMessageHistory(chain, get_session_history, input_messages_key="messages", output_messages_key="answer")
    return runnable
...
selected_topic = st.selectbox("আপনি কোন বিষয়ে শিখতে চান? (ঐচ্ছিক)",  # Which topic do you want to learn? (optional)
                               ...
                               format_func=lambda x: "কোনো বিষয় নয়" if x is None else topics[x], # Display "কোনো বিষয় নয়" in Bangla
...
model = setup_llm()
runnable = setup_runnable(model)

# Dynamic system prompt based on selected topic
if selected_topic:
    initial_prompt = f"আমি এখন {topics[selected_topic]} শিখতে চাই।"  # I want to learn {topic} now.
